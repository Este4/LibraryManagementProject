...
public class MenuView {
        ...
        menu.addOption("Dang xuat");
         ...
         while (true) {
            ...
            switch (menu.getChoice()) {
                ...
                case 6: {
                    System.out.println(">> " + borrowRecord.undo());
                    break;
                }
                case 7: {
                    System.out.println(">> " + borrowRecord.redo());
                    break;
                }
                case 8: {
                    showHistory();
   ...
   private void doBorrow(Member m) {
    ...
    System.out.println(">> " + borrowRecord.borrowBook(m, tb, book));
   ...
   private void doReturn(Member m) {
    ...
    TitleBook tb = bookMgr.searchTitleByid(book.getMasterId());
    System.out.println(">> " + borrowRecord.returnBook(m, tb, book));
    ...
    private void addTitle() {
        String id = Inputter.getAString("Ma dau sach: ", "Khong trong!");
        String t = Inputter.getAString("Ten sach: ", "Khong trong!");
        String au = Inputter.getAString("Tac gia: ", "Khong trong!");
        String g = Inputter.getAString("The loai: ", "Khong trong!");
        System.out.println(">> " + bookMgr.createTitle(id, t, au, g));
    }

    private void addEdition() {
        if (bookMgr.tList.isEmpty()) { System.out.println(">> Chua co dau sach nao!"); return; }

        Menu<TitleBook> tMenu = new Menu<>("CHON DAU SACH", "Chon: ", "Vui long chon ");
        TitleBook tb = tMenu.ref_getChoice(bookMgr.tList);

        String eId = Inputter.getAString("Ma an ban: ", "Khong trong!");
        ...
        int d = Inputter.getAnInteger("Ngay: ", "Sai!", 1, 28);

        System.out.println(">> " + bookMgr.addEdition(tb.getMasterId(), eId, qty, LocalDate.of(y, mo, d)));
    }
    ...
    private void updateQty() {
        ...
        System.out.println(">> " + bookMgr.updateQuantity(e.getEditId(), q));
    }
    ...
    private void deleteEdition() {
        ...
        System.out.println(">> " + bookMgr.deleteEdition(e.getEditId()));
    }
    ...
    private void addMember() {
        String id = Inputter.getAString("ID: ", "Khong trong!");
        String u = Inputter.getAString("Username: ", "Khong trong!");
        String p = Inputter.getAString("Password: ", "Khong trong!");
        ...
        System.out.println(">> " + memberMgr.createMember(id, u, p, st));
    }
    ...
    private void deleteMember() {
        ...
        System.out.println(">> " + memberMgr.deleteMember(m.getId()));
    }
